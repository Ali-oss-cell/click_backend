"""
Django settings for clickexpress_api project.
...
SECRET_KEY = config('SECRET_KEY', default='django-insecure-o@3c4b017jo&jubwo$%m-w44)f+-ap-)b+=#ol85_l$4tiur+a')
...
ROOT_URLCONF = 'clickexpress_api.urls'
...
WSGI_APPLICATION = 'clickexpress_api.wsgi.application'
...
ADMIN_EMAIL = config('ADMIN_EMAIL', default='admin@clickexpress.com')
